...
var SponsorsView = require('SponsorsView');
...
var AboutUsView = require('AboutUsView');
var CommitteesView = require('CommitteesView');
...
class F8TabsView extends React.Component {
  ...
  renderNavigationView() {
    ...
    if (this.props.user.isLoggedIn) {
      ...
      accountItem = (
        <View>
          <Image source={require('./img/karma-logo.png')} />
          <Text style={styles.name}>
            June 3 - 5 / KMCT CE
          </Text>
        </View>
      ...
      loginItem = (
        <View style={styles.loginPrompt}>
          <Text style={styles.loginText}>
            Log in to find your friends at Karma.
          </Text>
  ...
  renderContent() {
    ...
    case 'about':
      return <AboutUsView navigator={this.props.navigator} />;


      case 'sponsors':
      return <SponsorsView navigator={this.props.navigator} />
    case 'gallery':
      return <Gallery images={images}/>

    case 'committees':
        return <CommitteesView navigator={this.props.navigator} />
